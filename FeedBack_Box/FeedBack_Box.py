...
questionnaire={
    ...
    'responses':[{'value':1,'lib':u'Extrêmement'},{'value':2,'lib':u'Tout à fait'},{'value':3,'lib':u'Plutôt'},{'value':4,'lib':u'Non'}]
    },
    {
    'id':2,
    'type':'single',
    ...
    'type':'single',
     'isMandatory':True,
    'libelle':u'Quelle note de 1 à 10 donneriez-vous à cet élément (10 étant la meilleure note) ?',
    'responses':[{'value':2,'lib':u'1'},{'value':3,'lib':u'2'},{'value':4,'lib':u'3'},{'value':5,'lib':u'4'},
                 {'value':6,'lib':u'5'},{'value':7,'lib':u'6'},{'value':8,'lib':u'7'},{'value':9,'lib':u'8'},{'value':10,'lib':u'9'},{'value':11,'lib':u'10'}]
    },
    {
    'id':4,
    'type':'single',
